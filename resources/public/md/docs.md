...
Two middleware functions are provided by default in the `cbnews.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `cbnews.handler` namespace to manage the enabled middleware.
